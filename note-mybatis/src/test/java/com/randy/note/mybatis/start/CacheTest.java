...
class CacheTest {
    ...
    void test3(){
        ...
        User user2 = sqlSession2.selectOne("com.randy.note.mybatis.start.UserDao.query", 1);
        System.out.println(user2);
    ...
    void test4() throws IOException {
        ...
        com.randy.note.mybatis.cache.User user = sqlSession.selectOne("com.randy.note.mybatis.cache.UserDao.query", 1);
        ...
        com.randy.note.mybatis.cache.User user2 = sqlSession2.selectOne("com.randy.note.mybatis.cache.UserDao.query", 1);
        System.out.println(user2);
        sqlSession2.commit();
        sqlSession2.close();
    }
